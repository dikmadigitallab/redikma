...
function FrashPlayer({ src, muted, onToggleMute }: { src: string; muted: boolean; onToggleMute: () => void }) {
          ...
          {shouldTruncate && (
            <>
              ...
              {post.video && (
                ...
                >
                  <FrashPlayer src={post.video} muted={videoMuted} onToggleMute={() => setVideoMuted((v) => !v)} />
