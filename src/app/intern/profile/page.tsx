      ...
      <div className="p-6 md:p-8 border-b border-neutral-100 flex flex-col sm:flex-row items-center justify-between gap-6">
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <div className="relative group">
            ...
            />
            <input type="file" id="upload-foto" accept="image/*" onChange={handleFile} className="hidden" />
            <label
              htmlFor="upload-foto"
          ...
          <div className="text-center sm:text-left">
            <h1 className="text-xl font-black text-neutral-900 leading-tight">{user.nome}</h1>
        ...
        <div className="flex gap-4">
          <div className="bg-neutral-50 px-4 py-2 rounded-xl border border-neutral-100">
            <p className="text-[9px] font-bold text-neutral-400 uppercase tracking-tighter">CPF</p>
            <p className="text-xs font-bold text-neutral-700">{user.cpf}</p>
          </div>
          <div className="bg-neutral-50 px-4 py-2 rounded-xl border border-neutral-100">
            <p className="text-[9px] font-bold text-neutral-400 uppercase tracking-tighter">Cargo</p>
            <p className="text-xs font-bold text-neutral-700">{user.cargo}</p>
          </div>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-5">
          <div className="space-y-1.5">
            <label className="text-[11px] font-bold text-neutral-500 uppercase ml-1">E-mail Corporativo</label>
            <input
              type="email"
              name="email"
              value={form.email}
          ...
          <div className="space-y-1.5">
            <label className="text-[11px] font-bold text-neutral-500 uppercase ml-1">Telefone / WhatsApp</label>
            <input
              type="text"
              name="telefone"
              value={form.telefone}
          ...
          <div className="space-y-1.5 md:col-span-2">
            <label className="text-[11px] font-bold text-neutral-500 uppercase ml-1">Alterar Senha</label>
            <input
              type="password"
              name="senha"
