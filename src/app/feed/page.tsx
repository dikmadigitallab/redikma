        ...
        <div className="h-full px-4 md:px-[10%] flex items-center justify-between">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div className="hidden sm:block">
              <h1 className="text-sm md:text-lg font-bold" style={{ color: 'var(--primary-dark)' }}>Dikma</h1>
              <p className="text-xs" style={{ color: 'var(--gray)' }}>Rede Social</p>
            </div>
          </div>
          <div className="flex items-center gap-3 md:gap-6">
            ...
            <img src="https://i.pravatar.cc/100?img=2" alt="user" className="w-8 md:w-9 h-8 md:h-9 rounded-full cursor-pointer hover:opacity-70 transition" />
          </div>
        </div>
      </header>
